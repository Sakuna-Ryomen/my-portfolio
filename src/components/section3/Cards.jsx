...
const Cards = (props) => {
  ...
  return (
    <div className='w-50 h-50 border border-white/20 bg-gray-100/10 p-8 backdrop-blur-lg rounded-lg flex flex-col items-center hover:scale-110 hover: justify-center gap-4'>
